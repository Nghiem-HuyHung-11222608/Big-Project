        ...
        <div class="row">
		 ...
		 while ($row=mysqli_fetch_array($rs)) { ?>
                    <tr>
                        ...
                        <td><a class="text-primary" href="index.php?action=sanpham&view=suasp&masp=<?php echo $row['MaSP']; ?>">Sửa</a></td>
                        
                        <td><a class="text-danger" href="sanpham/main.php?view=xoasp&masp=<?php echo $row['MaSP']; ?>">Xóa</a></td>
                    </tr>
                    <?php	} ?>
