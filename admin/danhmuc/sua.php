<?php 
    $madm=$_GET['madm'];
    $sql_sua="SELECT * FROM `nhacc` WHERE MaNCC='$madm'";
  ...
  <form class="form-row " method="GET" action="danhmuc/xuly.php" enctype="multipart/form-data">
	 <div class="form-group col-sm-4"></div><input hidden name="madm" value="<?php echo $kq_sua['MaNCC'];?>">
    <div class="form-group col-sm-3"><label class="m-auto" for="">Tên Danh Mục</label>
    	<input type="text" class="form-control" name="tendm" autofocus value="<?php echo $kq_sua['TenNCC'];?>"></div>
