...
<div class="container-fluid">
    <div class=" alert alert-primary">
        <h4 class="page-title">
            ...
            </span> ADMIN &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Khuyến mãi&#160;<i
                class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Apply &#160;<i
                class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $kq['TenKM'] ?>
        </h4>
    </div>
</div>
    ...
    <div class="form-group col-sm-4">
        <form action="index.php?action=khuyenmai&view=apply&makm=<?php echo $id ?>" method="POST">
            <div class="input-group ">
                <input class="form-control   border search " type="search" placeholder="Nhập sản phẩm cần tìm"
                    id="example-search-input" name="tk" />
                <span class="input-group-append">
                    <button class="btn btn-outline-success btn-sm   search " name="btsearch" type="submit">Tìm
                        kiếm</button>
                </span>
            </div>
        </form>
...
<form action="index.php?action=khuyenmai&view=apply&makm=<?php echo $id ?>" method="POST" class="container-fluid ">
    <div class="card">
        <div class=" card-body row m-auto">
            ...
            <button class="btn" value="<?php echo $row['MaNCC'] ?>" type="submit"
                name="th"><?php echo $row['TenNCC'] ?></button><?php }?>
        </div>
    </div>
...
<form action="khuyenmai/xuly.php" method="get" accept-charset="utf-8" class="container-fluid">
    <div class="card card-body">
        <table class="table-hover table text-center">
            ...
            <tbody>
                <tr>
                <td><img src="../webroot/image/sanpham/<?php echo $row['AnhNen'];?>" width="60" height="50">
                        </td>
