...
// Khởi tạo bản đồ và đặt tọa độ trung tâm ở Hà Nội
var map = L.map('map').setView([20.996260338519754, 105.85019029675765], 13);
...
L.marker([20.996260338519754, 105.85019029675765]).addTo(map)
    .bindPopup('Huy Hưng shoes ');
